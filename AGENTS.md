...
├── cartog-languages   (tree-sitter extractors, 16 languages + SFC/JSX)
...
- **Languages**: Python, TypeScript/JavaScript, Rust, Go, Ruby, Java, C#, PHP, Dart, Swift, Kotlin, Vue, Svelte, Astro, Markdown
