...
run_scenario "webapp_csharp" "Routes/AuthRoutes.cs" "^using "
run_scenario "webapp_c" "routes/auth_routes.c" "^#include "
run_scenario "webapp_cpp" "routes/auth_routes.cpp" "^#include "
run_scenario "webapp_php" "routes/auth.php" "^use "
run_scenario "webapp_swift" "Sources/webapp/routes/AuthRoutes.swift" "^import "
run_scenario "webapp_kt" "src/main/kotlin/webapp/routes/AuthRoutes.kt" "^import "
