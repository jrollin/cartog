...
run_scenario "webapp_c" "handle_login" "authenticate" "login" "generate_token" "execute_query" "get_connection"
run_scenario "webapp_cpp" "handle_login" "authenticate" "login" "generate_token" "execute_query" "get_connection"
