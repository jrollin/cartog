...
run_scenario "webapp_csharp" "Auth/TokenService.cs"
run_scenario "webapp_php" "auth/service.php"
run_scenario "webapp_swift" "Sources/webapp/auth/Service.swift"
run_scenario "webapp_kt" "src/main/kotlin/webapp/auth/Service.kt"
run_scenario "webapp_c" "auth/token_service.c"
run_scenario "webapp_cpp" "auth/token_service.cpp"
run_scenario "webapp_vue" "src/components/LoginForm.vue"
run_scenario "webapp_svelte" "src/components/UserBadge.svelte"
run_scenario "webapp_astro" "src/components/UserBadge.astro"
run_scenario "webapp_react" "src/components/LoginForm.tsx"
