...
run_scenario "webapp_java" "handleLogin" "login" "generateToken"
run_scenario "webapp_csharp" "HandleLogin" "Login" "GenerateToken"
run_scenario "webapp_c" "handle_login" "login" "generate_token"
run_scenario "webapp_cpp" "handle_login" "login" "generate_token"
run_scenario "webapp_php" "login_route" "login" "generate_token"
run_scenario "webapp_swift" "handleLogin" "login" "generateToken"
run_scenario "webapp_kt" "handleLogin" "login" "generateToken"
