...
#   ./benchmarks/token_savings.sh --fixture c      # Run only C fixtures
#   ./benchmarks/token_savings.sh --fixture cpp    # Run only C++ fixtures
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            echo "Usage: $0 [--scenario NN] [--fixture py|ts|go|rs|rb|java|c|cpp|csharp|php|dart|swift|kt]"
            exit 0
            ;;
