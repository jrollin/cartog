...
- **[cartog-languages](../crates/cartog-languages/README.md)** — `Extractor` trait + 10 code extractors (Python, TypeScript (.ts, .tsx), JavaScript, Rust, Go, Ruby, Java, PHP, Dart, Swift) + Markdown extractor.
