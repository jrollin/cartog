...
- [project-registry.md](project-registry.md) — user-global registry of indexed projects: `cartog projects`, `cartog_list_projects`, and self-populated descriptions (all shipped); later phases (federated queries) proposed
